...
export const commandRunAction = defineAction({
  ...
  description:
    'Run a Neon slash command such as /repo-status, /review-queue, /review-pr, /fix-ci, /explain-ci, /summarize-pr, /draft-pr-description, /prepare-pr, /review-local, /briefing, /reasoning, /memory, /watch-pr, /watch-release, or /dev-doctor and persist a workflow summary.',
