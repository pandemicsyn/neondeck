...
export const watchPrAddAction = defineTool({
  ...
  async run({ data: input }) {
    return { output: await addPrWatch(input) };
  },
});

export const watchPrListAction = defineTool({
...
export const watchPrRemoveAction = defineTool({
  ...
  output: watchActionOutputSchema,
  async run({ data: input }) {
    return { output: await removePrWatch(input) };
  },
});

export const watchPrPollingAction = defineTool({
  ...
  output: watchActionOutputSchema,
  async run({ data: input }) {
    return { output: await setPrWatchPolling(input) };
  },
});

export const watchPrRefreshAction = defineTool({
  ...
  output: watchActionOutputSchema,
  async run({ data: input }) {
    return { output: await refreshPrWatch(input) };
  },
});

export const watchRefAddAction = defineTool({
  ...
  output: watchActionOutputSchema,
  async run({ data: input }) {
    return { output: await addRefWatch(input) };
  },
});

export const watchRefListAction = defineTool({
...
export const watchRefRefreshAction = defineTool({
  ...
  output: watchActionOutputSchema,
  async run({ data: input }) {
    return { output: await refreshRefWatch(input) };
  },
});
