...
export const preparedDiffsLookupTool = defineTool({
  ...
  async run({ data: input }) {
    return { output: await listPreparedDiffs(input) };
  },
});

export const preparedDiffListAction = defineTool({
...
export const preparedDiffSummaryAction = defineTool({
  ...
  output: outputSchema,
  async run({ data: input }) {
    return { output: await readPreparedDiffSummary(input) };
  },
});

export const preparedDiffChangedFilesAction = defineTool({
  ...
  output: outputSchema,
  async run({ data: input }) {
    return { output: await readPreparedDiffChangedFiles(input) };
  },
});

export const preparedDiffFileDiffAction = defineTool({
  ...
  output: outputSchema,
  async run({ data: input }) {
    return { output: await readPreparedDiffFileDiff(input) };
  },
});
