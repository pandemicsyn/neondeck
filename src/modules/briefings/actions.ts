...
export const briefingProfileReadAction = defineTool({
  ...
  output: outputSchema,
  async run() {
    return { output: await readBriefingState() };
  },
});

export const briefingProfileUpdateAction = defineTool({
  ...
  async run({ data: input }) {
    return { output: await updateBriefingProfile(input) };
  },
});

export const briefingRunReadAction = defineTool({
  ...
  output: outputSchema,
  async run({ data: input }) {
    return { output: await readBriefingRunDetails(input.id) };
  },
});

export const briefingRunNowAction = defineTool({
  ...
  output: outputSchema,
  async run({ data: input }) {
    return { output: await runBriefingNow(input) };
  },
});

export const briefingSessionRotateAction = defineTool({
  ...
  output: outputSchema,
  async run({ data: input }) {
    return { output: await rotateBriefingSession(input) };
  },
});
