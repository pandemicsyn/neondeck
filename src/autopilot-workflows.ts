...
const failingCheckFixtureSchema = v.looseObject({
  id: v.number(),
  name: nonEmptyStringSchema,
  headSha: nonEmptyStringSchema,
  status: nonEmptyStringSchema,
...
const autopilotFixtureSchema = v.object({
...
async function dependenciesWithAutopilotFixture(
  dependencies: AutopilotDependencies,
