...
export async function skillPatchesModule() {
  return import(
    new URL('../skill-patches.ts', import.meta.url).href
  ) as Promise<typeof import('../skill-patches')>;
}

export async function watchActionsModule() {
  return import(
    new URL('../watch-actions.ts', import.meta.url).href
  ) as Promise<typeof import('../watch-actions')>;
}
