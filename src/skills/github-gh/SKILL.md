---
name: github-gh
description: Choose between deterministic GitHub API tools, local git facts, and approved gh CLI workflows in Neondeck.
---

# GitHub and gh Runtime Guidance

Use this skill when the user asks about GitHub pull requests, CI checks, local branches, release readiness, or whether Neon should use GitHub API tools, local git, or the `gh` CLI.

## Prefer Deterministic Neondeck Tools

Use Neondeck's typed tools and app APIs before reasoning:
...
- Use watch tools for persistent PR or release monitoring instead of repeatedly polling from chat.
...
- the GitHub API tool cannot expose the needed fact yet
...
1. State the deterministic facts returned by Neondeck tools.
