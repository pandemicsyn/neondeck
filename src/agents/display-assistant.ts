...
export default defineAgent(() => ({
  ...
  instructions: [
    ...
    'For release watches, run /watch-release or create a release-watch scheduler blueprint. Provider-specific deploy checks are not available yet; release watches currently track default-branch GitHub checks.',
