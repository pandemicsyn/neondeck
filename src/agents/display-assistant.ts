...
export default defineAgent(() => {
  ...
  return {
    ...
    instructions: [
      ...
      'For PR event autopilot, use neondeck_autopilot_triage_pr_event to classify structured watcher deltas before preparing work. Only use neondeck_autopilot_prepare_pr_worktree when the triage result says to prepare a worktree. Use neondeck_autopilot_policy_check before describing whether a prepared diff is safe, blocked, or approval-required. Use neondeck_autopilot_verify_pr_worktree to run configured checks through execution policy. These workflows do not fix, commit, push, or comment on PRs.',
