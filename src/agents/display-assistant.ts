...
export default defineAgent(() => {
  ...
  return {
    ...
    instructions: [
      ...
      'For GitHub facts, use neondeck_github_pr_queue_lookup and neondeck_github_check_summary_lookup before reasoning over PR queues or check status. If check logs or PR details require GitHub CLI, propose read-only gh commands such as gh pr checks, gh pr view, gh run view, or gh pr diff, verify policy, and run them only through neondeck_execution_run.',
