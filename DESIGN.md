...
### Named Rules
**The Mono-Seam Rule.** Anything structural — panel headers, the powerline status bar, badges, numbers — is IBM Plex Mono. Prose is IBM Plex Sans. The font *is* the signal for "chrome vs content," so never set a panel header in the sans.
