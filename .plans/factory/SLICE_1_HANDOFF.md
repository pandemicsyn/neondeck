...
| 5 — GitHub status              | Uncommitted implementation candidate; final verification and reviews pending | `agent/factory-s1-05-github-status`; accepted base `836dfe24dbb6b790865523b37f68d2b64ec9035c` plus local delta            | Not opened | Opt-in status, immutable public approvals, durable recovery, echo controls and repair UI; see increment 5 operator guide. Manager owns two static reviews and final review before publication.                                                        |
| Full slice / deployed exercise | Local code candidate; deployed acceptance incomplete                         | Final reviewed identity to be recorded by manager                                                                         | —          | Final-stack deterministic verification and evidence accompany the frozen candidate. Real GitHub test issue, final live provider conversation, VM restart and anonymous external exposure checks remain pending authorization. No merge or deployment. |
