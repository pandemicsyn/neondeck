...
for (const requiredPath of [
  ...
  'dist/server.mjs',
  'dist/local-host.mjs',
  'dist/assets/coding-runs/local-supervisor.mjs',
  'dist/assets/coding-runs/local-anchor.mjs',
  'src/modules/coding-runs/adapters/contract.ts',
  'src/modules/coding-runs/adapters/registry.ts',
  'src/modules/coding-runs/adapters/codex.ts',
