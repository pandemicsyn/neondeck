...
export const relayBroadcastInputSchema = z.object({
...
export const clientControlFrameSchema = z.object({
  version: protocolVersionSchema,
  type: z.literal("ping"),
}).strict();

export const serverControlFrameSchema = z.object({
  version: protocolVersionSchema,
  type: z.literal("pong"),
}).strict();
...
export type GithubWebhookEnvelope = z.infer<
